...
namespace VoucherPro
{
    public class Layouts
    {
        ...
        private void Layout_CheckVoucher_Check_LEADS(PrintPageEventArgs e, StringFormat sfAlignCenterRight, StringFormat sfAlignCenter, StringFormat sfAlignLeftCenter, StringFormat sfAlignRight)
        {
