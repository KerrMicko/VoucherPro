...
namespace VoucherPro.Clients
{
    public class Layouts_LEADS
    {
        ...
        private void Layout_CheckVoucher_Check_Leads(PrintPageEventArgs e, List<CheckTableExpensesAndItems> checkData, string seriesNumber, StringFormat sfAlignCenterRight, StringFormat sfAlignCenter, StringFormat sfAlignLeftCenter, StringFormat sfAlignRight)
        {
        ...
        private void Layout_CheckVoucher_Bill_Leads(PrintPageEventArgs e, List<BillTable> billData, string seriesNumber, StringFormat sfAlignCenterRight, StringFormat sfAlignCenter, StringFormat sfAlignLeftCenter, StringFormat sfAlignRight)
        {
            Font font_Header = font_EightBold;
            Font font_Data = font_Eight;
